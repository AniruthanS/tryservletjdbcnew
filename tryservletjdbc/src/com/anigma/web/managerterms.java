...
@WebServlet("/managertermsservlet")
public class managerterms extends HttpServlet {
     public void service(ServletRequest req, ServletResponse res ) throws IOException, ServletException {
 		...
 		// String Company;
 			...
 			res.getWriter().print("<caption> Terms : </caption>");
...
// 				i=i+1;
 			...
 			res.getWriter().print("<a href=\"./manageroption.html\">main menu...</a>");
